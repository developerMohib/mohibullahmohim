            ...
            <div>
                ...
                >
                    ...
                    <div className="relative">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center md:py-6">
                            {/* Text Content */}
                            <motion.div
                ...
                {/* Hero Banner Section */}
                <div className="relative flex items-center justify-center overflow-hidden bg-white dark:bg-gray-900 py-20 ">
                    ...
                    <div className="relative px-4 sm:px-6 lg:px-8 text-center z-10">
                        ...
                        >
                            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white leading-tight">
                                ...
                                <span className="relative">
                                    <motion.span
                                        className="bg-gradient-to-r from-blue-600 via-red-600 to-green-600 dark:from-blue-400 dark:via-red-400 dark:to-green-400 bg-clip-text text-transparent bg-[length:200%_100%]"
                                        animate={{
                                            backgroundPosition: ["0% 50%", "100% 50%", "0% 50%"]
                                        }}
                                        transition={{
