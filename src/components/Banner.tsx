    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <motion.section
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="relative min-h-screen py-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-linear-to-br from-gray-900 to-blue-900/20 flex items-center"
            >
                ...
                <div className="container mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6 text-left">
                        <Badge variant="secondary" className="px-3 py-1 text-sm bg-blue-500/20 text-blue-300">
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            <Button onClick={openBookForm} className="bg-linear-to-r from-blue-600 to-purple-600 text-white px-8 py-6 rounded-xl font-semibold shadow-lg">
                                <Mail className="w-5 h-5 mr-2" /> Get In Touch
                            </Button>
                            <Button variant="outline" onClick={() => window.open('https://drive.google.com/file/d/1Pxsl94hutSkC16r3M-i-Tua_JP8J03OX/view?usp=drive_link', '_blank' ,'noopener,noreferrer')} className="px-8 py-6 rounded-xl font-semibold border-gray-600">
            ...
            <section className="relative overflow-hidden bg-gray-900 py-24 border-t border-gray-800">
                <BannerBackground />
...
const ProfileCard = () => (
    <motion.div
        ...
        className="relative w-full max-w-100 aspect-square flex items-center justify-center"
    >
        {/* Rings Background */}
        ...
        <div className="relative z-20 text-center p-6 bg-black/10 backdrop-blur-md rounded-3xl border border-white/10 shadow-2xl">
            <motion.div
                animate={{ rotate: [0, 360] }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                className="w-20 h-20 bg-linear-to-r from-blue-600 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center"
            >
                <Code className="w-10 h-10 text-white" />
            </motion.div>

            <h3 className="text-xl font-bold text-white">Mohibullah Mohim</h3>
...
const AnimatedGradientText = ({ text }: { text: string }) => (
    <motion.span
        className="bg-linear-to-r from-blue-400 via-red-500 to-blue-400 bg-clip-text text-transparent bg-size-[200%_auto]"
