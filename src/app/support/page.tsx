        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            <TabsList className="grid w-full grid-cols-3 max-w-2xl mx-auto">
              <TabsTrigger value="services" className="text-sm md:text-base">Support Services</TabsTrigger>
              <TabsTrigger value="pricing" className="text-sm md:text-base">Support Plans</TabsTrigger>
              <TabsTrigger value="contact" className="text-sm md:text-base">Get Support</TabsTrigger>
            </TabsList>
                    ...
                    <CardContent>
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <select id="urgency" className="w-full px-3 py-2 border border-gray-300 rounded-md bg-black">
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea
                            id="description"
                            placeholder="Please describe your issue in detail, including error messages, steps to reproduce, and any relevant context..."
                            rows={6}
                            required
                          />
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Get the help you need to keep your projects running smoothly.
              Technical support, consultation, and emergency assistance available.
            </p>
          </motion.div>
