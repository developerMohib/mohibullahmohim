                    ...
                    >
                        ...
                        <div className="p-5">
                            ...
                            <div className="py-3 flex items-center justify-between bg-white">
                                <span className="group flex items-center text-xs text-orange-400 hover:text-red-600 transition-all center ">
                                    <Eye size={14} />
                                ...
                                <span className="group flex items-center text-xs text-orange-400 hover:text-red-600 transition-all">
                                    <GitBranch size={14} />
